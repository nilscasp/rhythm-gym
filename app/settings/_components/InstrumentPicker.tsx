...
// ─────────────────────────────────────────────────────────────────────────────
// InstrumentPicker — der gemeinsame Wähl-und-Bau-Weg für ein Instrument.
//
...
//           danach Speichern via saveHandpanAction (legt handpans-Row an und
//           setzt profiles.active_handpan_id).
//
// Zwei Aufrufer, ein Weg: das Onboarding (OnboardingInstrumentStep, ohne
// returnTo → Redirect nach /training, unverändert zu vorher) und die
// Einstellungen (InstrumentSection, returnTo='/settings' → zurück aufs Profil).
// Der Unterschied ist genau ein verstecktes Feld; alles andere bleibt gleich,
// damit die beiden Wege nicht auseinanderdriften.
//
