...
export interface RhythmusPreset {
  ...
  hint?: string;
  /** Strike sequence: 1–32 chars from set `.gTSDXP` (X = Slap + Tonfeld gleichzeitig, P = Pulston: immer dasselbe Tonfeld). */
  pattern: string;
...
export const RHYTHMUS_DAYS: readonly RhythmusDay[] = [
  ...
  },
  {
    ...
    presets: [
      {
        id: 'station-1-drei',
        label: 'Station 1 · Die Drei einsaugen',
        hint: 'Ding auf jeder 1 der Dreiergruppe, Handsatz wechselt je Gruppe',
        pattern: 'DggDgg',
        handsatz: 'R-L',
        bpm: 36,
        subdivision: '8t',
      ...
      {
        id: 'station-2-sechs',
        label: 'Station 2 · Verdoppeln auf Sechs',
        hint: 'Nur das erste Ding, der Rest läuft leise mit',
        pattern: 'Dggggg',
        handsatz: 'R-L',
        bpm: 36,
        subdivision: '8t',
      ...
      {
        id: 'station-3-zwoelfer',
        label: 'Station 3 · Der Zwölfer-Takt',
        hint: 'Ding auf 1, Slap auf 2 und 4, Bogen 3 still',
        pattern: 'DggSgggggSgg',
        handsatz: 'R-L',
        bpm: 36,
        subdivision: '8t',
      },
      {
        id: 'station-4-tonfelder',
        label: 'Station 4 · Slaps wandern auf Tonfelder',
        hint: 'Probier die komischsten Kombinationen',
        pattern: 'DggTgggggTgg',
        handsatz: 'R-L',
        bpm: 36,
        subdivision: '8t',
      },
      {
        id: 'station-5-links',
        label: 'Station 5 · Die andere Hand startet',
        hint: 'Derselbe Zwölfer, mit links beginnend',
        pattern: 'DggSgggggSgg',
        handsatz: 'L-R',
        bpm: 36,
        subdivision: '8t',
  ...
  },
  {
    ...
    presets: [
      {
        id: 'frahm-puls',
        label: 'Nachempfinden · eine Taste',
        hint: 'Ein Ton auf jeder Triole — Frahms Beginn als Ausgangspunkt',
        pattern: 'PPPPPPPPPPPP',
        handsatz: 'frei',
        bpm: 56,
        subdivision: '8t',
      },
  ...
  },
  {
    ...
    presets: [
      {
        id: 'unterlage',
        label: 'Unterlage für deinen Körper',
        hint: 'Der Zwölfer aus Tag 34 — wie lang dein Körper wird, bestimmt dein Ohr',
        pattern: 'DggSgggggSgg',
        handsatz: 'R-L',
        bpm: 56,
        subdivision: '8t',
  ...
  },
  {
    ...
    presets: [
      {
        id: 'pulston',
        label: 'Linke Hand · Pulston',
        hint: 'Ein einziger Ton, auf jeder Triole',
        pattern: 'PPPPPPPPPPPP',
        handsatz: 'frei',
        bpm: 56,
        subdivision: '8t',
      ...
      {
        id: 'motiv-1-akkorde',
        label: 'Bogen 1+2 · zwei Akkorde',
        hint: 'Akzent auf 1 · 3 · 4, Schlag 2 still — Akkord A, dann B',
        pattern: 'TPPPPPTPPTPP' + 'TPPPPPTPPTPP',
        handsatz: 'frei',
        bpm: 56,
        subdivision: '8t',
      },
      {
        id: 'motiv-2-einzeltoene',
        label: 'Bogen 3–6 · drei Einzeltöne',
        hint: 'Dieselben Zählzeiten, jetzt Einzeltöne im Wechsel',
        pattern: 'TPPPPPTPPTPP' + 'TPPPPPTPPTPP',
        handsatz: 'R-L',
        bpm: 56,
        subdivision: '8t',
  ...
  },
  {
    ...
    presets: [
      {
        id: 'phase-1-eine-taste',
        label: 'Phase 1 · Eine Taste',
        hint: 'Ein Tonfeld im Puls — eine Minute, nur Anschlag und Dynamik',
        pattern: 'PPPPPPPPPPPP',
        handsatz: 'frei',
        bpm: 56,
        subdivision: '8t',
      ...
      {
        id: 'phase-2-bass',
        label: 'Phase 2 · Die Bassnote tritt ein',
        hint: 'Ein tiefer Ton unter dem Puls',
        pattern: 'DPPPPPPPPPPP',
        handsatz: 'frei',
        bpm: 56,
        subdivision: '8t',
      },
      {
        id: 'phase-3-motiv',
        label: 'Phase 3 · Das Motiv aus gestern',
        hint: 'Akzent auf 1 · 3 · 4 über dem Puls',
        pattern: 'TPPPPPTPPTPP' + 'TPPPPPTPPTPP',
        handsatz: 'frei',
        bpm: 56,
        subdivision: '8t',
      },
      {
        id: 'phase-4-break',
        label: 'Phase 4 · Break',
        hint: 'Stille — dann kommt das Motiv aus dem Nichts zurück',
        pattern: '............' + 'TPPPPPTPPTPP',
        handsatz: 'frei',
        bpm: 56,
        subdivision: '8t',
      },
  ...
  },
  {
    ...
    presets: [
      {
        id: 'phase-1-anker',
        label: 'Phase 1 · Der perkussive Anker',
        hint: 'Ding auf 1, Slap auf 2, dazwischen die Wiederholung',
        pattern: 'DPPSPPPPPPPP',
        handsatz: 'frei',
        bpm: 48,
        subdivision: '8t',
      },
      {
        id: 'phase-2-ein-akkord',
        label: 'Phase 2 · Ein einziger Akkord',
        hint: 'Akkord auf 1 · 3 · 4 über Ding und Slap',
        pattern: 'TPPSPPTPPTPP',
        handsatz: 'frei',
        bpm: 48,
        subdivision: '8t',
      },
      {
        id: 'phase-3-motiv-1',
        label: 'Phase 3 · Motiv 1 · zwei Akkorde',
        hint: 'Akkord A in Bogen 1, Akkord B in Bogen 2',
        pattern: 'TPPSPPTPPTPP' + 'TPPSPPTPPTPP',
        handsatz: 'frei',
        bpm: 48,
        subdivision: '8t',
      },
      {
        id: 'phase-4-motiv-2',
        label: 'Phase 4 · Motiv 2 · drei Tonfelder',
        hint: 'Tonfeld auf 1 übernimmt das Ding, Slap bleibt auf 2',
        pattern: 'TPPSPPTPPTPP' + 'TPPSPPTPPTPP',
        handsatz: 'R-L',
        bpm: 48,
        subdivision: '8t',
  ...
  },
  {
    ...
    presets: [
      {
        id: 'phase-1-basis',
        label: 'Phase 1 · Der Basis-Rhythmus läuft',
        hint: 'Die Wiederholung — ruhig und schlicht',
        pattern: 'PPPPPPPPPPPP',
        handsatz: 'frei',
        bpm: 48,
        subdivision: '8t',
      ...
      },
      {
        ...
        hint: 'Gleiche Zählzeiten, anderer Charakter',
        pattern: 'TPPPPPTPPTPP' + 'TPPPPPTPPTPP',
        handsatz: 'R-L',
        bpm: 48,
        subdivision: '8t',
      },
      {
        ...
        label: 'Phase 4 · Die perkussive Ebene dazu',
        hint: 'Ding auf 1, Slap auf 2 — dann wieder wegnehmen',
        pattern: 'DPPSPPTPPTPP' + 'DPPSPPTPPTPP',
        handsatz: 'frei',
        bpm: 48,
        subdivision: '8t',
      },
      {
        id: 'phase-5-break',
        label: 'Phase 5 · Twist · ein Break',
        hint: 'Am Ende eines Bogens einen Schlag auslassen',
        pattern: 'TPPSPPTPPTPP' + 'TPPSPPTPP.PP',
        handsatz: 'frei',
        bpm: 48,
        subdivision: '8t',
      },
  ...
  // Tonfeld/Akkord auf 1 · 3 · 4, Slap auf 2, dazwischen die Wiederholung als Pulston (P).
    ...
    presets: [
      {
        ...
        hint: 'Tonfeld auf 1 · 3 · 4, Slap auf 2, dazwischen der Pulston',
        pattern: 'TPPSPPTPPTPP' + 'TPPSPPTPPTPP',
        handsatz: 'frei',
        bpm: 56,
        subdivision: '8t',
      },
      {
        ...
        pattern: 'TPPSPPTPPTPP' + 'TPPSPPTPPTTT',
        handsatz: 'frei',
        bpm: 56,
        subdivision: '8t',
      },
  ...
  },
  {
    ...
    presets: [
      ...
      },
      {
        ...
        pattern: 'TPPSPPTPPTPP' + 'TPPXPPTPPTPP',
        handsatz: 'frei',
        bpm: 56,
        subdivision: '8t',
      },
      {
        ...
        pattern: 'TPPSPPTPPTPP' + 'TPPXPPTPPTTT',
        handsatz: 'frei',
        bpm: 56,
        subdivision: '8t',
      },
      {
        ...
        hint: 'Slap pausiert, Tonfelder und Pulston laufen weiter',
        pattern: 'TPPSPPTPPTPP' + 'TPPPPPTPPTPP',
        handsatz: 'frei',
        bpm: 56,
        subdivision: '8t',
      },
  ...
  },
  {
    ...
    presets: [
      ...
      },
      {
        ...
        pattern: 'TPPSPPTPPTTT' + 'TPPXPPTPPTPP',
        handsatz: 'frei',
        bpm: 60,
        subdivision: '8t',
      },
      {
        ...
        hint: 'Ausatmen ohne Slap — dann zurück in den Körper',
        pattern: 'TPPPPPTPPTPP' + 'TPPSPPTPPTPP',
        handsatz: 'frei',
        bpm: 60,
        subdivision: '8t',
      },
